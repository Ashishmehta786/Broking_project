...
export const Contact= () => {
  ...
  <div className=" mt-10 flex flex-col bg-yellow-50  p-6 md:p-10 rounded-xl shadow-lg md:w-[700px] w-[90%]  ">
      <h2 className="text-3xl font-medium text-slate-900 mb-6">Query Us</h2>
      <form>
        <div className="mb-4">
